export const COMMANDS = [
  ...
  ["cas_new", "Start a new Codex thread quickly in Full Access mode using the resolved workspace."],
  ...
  ["cas_verify", "Show or update verification state for the current cockpit task card."],
  ["cas_checkpoint", "Show or update the resumable checkpoint for the current cockpit task card."],
